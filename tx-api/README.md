...
This module provides a decorator of the Neo4j Transaction Event API (called [`TransactionData`](http://docs.neo4j.org/chunked/2.2.1/javadocs/org/neo4j/graphdb/event/TransactionData.html)).
...
[`TransactionEventHandler`](http://docs.neo4j.org/chunked/2.2.1/javadocs/org/neo4j/graphdb/event/TransactionEventHandler.html)s.
